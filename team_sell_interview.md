...
The fine art of airing Nav’s dirty laundry, while also making it clear why we stay.
...
Signals: All of the other interviews focus on whether the candidate fits Nav, but this interview should focus on whether Nav fits the candidate. We need them, they don’t necessarily need us. Let’s make sure we fit their goals. 

These questions are here as examples if there is a lull in the conversation. They are meant to flesh out the similarities and differences between Nav and what the candidate is looking for in their next role. If we match, talk it up! If we don’t, make sure the candidate knows what situation they would be walking into. Be honest! Tell them about where we are, not just where we want to be.
...
If a candidate still chooses Nav knowing what adventures and pitfalls await them, they are signing up to help. They are far more likely to stay with us longer. They are more invested in the growth of Nav, the technology, and their team.

Questions to figure out what they do and don’t want in their next role that Nav may not be able to match:
...
* Explain the role of a very accountable stakeholder, how they fall into the ecosystem at Nav, and how they influence project decisions. Is this something they will be okay with?
...
* What are your concerns about joining Nav? 
